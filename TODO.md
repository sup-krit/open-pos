...
- [ ] **Promotion engine** (`backend/app/services/promotions.py`):
  ...
  - [ ] Per-customer coupon redemption limit — needs a redemption-history table
...
- [ ] Back-office pages still static/unwired: Inventory inline-edit, Customers, Accounting upload
